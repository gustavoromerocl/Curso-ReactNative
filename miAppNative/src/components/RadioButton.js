            ...
            <View style={styles.container}>
                ...
                >
                    ...
                    <View style={styles.radioButton}>
                        <View style={[ styles.radioButtonNotSelected, selected == 0 && styles.radioButtonSelected]}/>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity 
                    ...
                    <Text>Item 2</Text>
                    <View style={styles.radioButton}>
                        <View style={[ styles.radioButtonNotSelected, selected == 1 && styles.radioButtonSelected]}/>
                    </View>
                </TouchableOpacity>
            </View>
        )
